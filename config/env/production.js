...
module.exports = {
  ...
  **************************************************************************/
  datastores: {
    ...
    ***************************************************************************/
    default: {
      adapter: 'sails-mongo',
      url: 'mongodb://dev:devtotest@localhost:27017/dental-app',
      //--------------------------------------------------------------------------
  ...
  ***************************************************************************/
  session: {
    ...
    ***************************************************************************/
    ...
    secret: '4fc25683e3f7a009c5df170e0089a370',
  ...
  **************************************************************************/
  ssl: {
    key: fs.readFileSync('config/env/ssl/key.pem', 'utf8'),
    cert: fs.readFileSync('config/env/ssl/cert.pem', 'utf8')
  },
